export const WHATSAPP_NUMBER = '5516997477753'
export const WHATSAPP_MESSAGE = 'Oi, Higor. Vi seu site e queria conversar sobre o meu caso.'
export const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`

export const CRP = 'CRP 06/210722'
export const PROFESSIONAL_NAME = 'Higor Joioso'
export const PHONE_DISPLAY = '(16) 99747-7753'
